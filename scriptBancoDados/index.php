...
// Comando para criar  a tabela "Produtos" com as colunas "id", "nome", "caminho", "descricao", "complemento" e "tamanho".
...
// Inserindo dados a tabela "Produtos", com a coluna "tamanho".
$dados = "INSERT INTO Produtos (nome, caminho, preco, descricao, complemento, tamanho) VALUES
...
Além de sua imponência visual, o cacto bola é uma excelente escolha comercial por sua durabilidade, baixa demanda hídrica e apelo decorativo. Seja como peça central em ambientes internos ou como elemento de contraste em áreas externas, ele oferece personalidade e elegância com um toque exótico.', '<ul><li><b>Dimensões aproximadas:</b> 15–25 cm de diâmetro</li><li><b>Ambiente ideal:</b> Sol pleno ou meia sombra</li><li><b>Regas:</b> 1 vez por semana (em clima quente)</li><li><b>Diferencial:</b> Espinhos dourados e formato escultural</li></ul>', 600)";

// Comando que executa $dados, inseri dados na tabela "Produtos".
mysqli_query($conexao, $dados);

// Inserindo dados a tabela "Produtos", sem a coluna "tamanho".
$dados = "INSERT INTO Produtos (nome, caminho, preco, descricao, complemento) VALUES
